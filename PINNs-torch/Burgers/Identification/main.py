...
if __name__ == "__main__":
    ...
    torch.save(pinn.net.state_dict(), r"D:\02_github\PINNs-torch\Burgers\Identification\weight_clean2.pt")
    pinn.net.load_state_dict(torch.load(r"D:\02_github\PINNs-torch\Burgers\Identification\weight_clean2.pt"))
    calcError(pinn)
